...
import { Video, FileText, Calendar, Users, BookOpen, MessageSquare, Plus, Settings, Eye, TrendingUp } from 'lucide-react';
...
const TeacherDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-sm text-gray-600">Add new courses to the platform</p>
          </button>
      ...
      {/* Course Details */}
      <div className="bg-white rounded-xl shadow-sm border p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">My Courses & Student Count</h2>
            ...
            {courses.map((course) => (
              <div key={course.id} className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="space-y-1 text-sm text-gray-600">
                  <p><Users className="w-4 h-4 inline mr-1" />{course._count?.enrollments || 0} students</p>
                  <p><FileText className="w-4 h-4 inline mr-1" />{course._count?.materials || 0} materials</p>
                  <p><Video className="w-4 h-4 inline mr-1" />{course._count?.lectures || 0} lectures</p>
                </div>
              </div>
            ))}
          </div>
